...
public interface IDamageResistanceExceptionSystem : IDependency<IDamageResistanceExceptionSystem>,
    IEntityTableSystem<DamageResistanceException>
{
...
{
    public override CoreDictionary<Entity, DamageResistanceException> Table =>
        IDataSystem.Resolve().Data.damageResistanceException;
